...
import { baseURL, about, notes, person } from "@/resources";
...
export default async function NotePage({
  ...
  let post = getPosts(["src", "app", "notes", "posts"]).find((post) => post.slug === slugPath);
    ...
    <Row fillWidth>
      ...
      <Row fillWidth horizontal="center">
        <Column as="section" maxWidth="xs" gap="l">
          ...
          />
          <Button data-border="rounded" href="/notes" variant="tertiary" prefixIcon="chevronLeft">
            Notes
          </Button>
